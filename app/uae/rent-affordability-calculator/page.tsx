...
export const metadata: Metadata = {
    title: "Rent Affordability Calculator UAE 2025 — Dubai & Abu Dhabi",
    description: "How much rent can you afford in the UAE? Enter your salary to find your max rent, total move-in costs (deposit, agency, Ejari), monthly housing budget, and affordable areas in Dubai & Abu Dhabi. Updated with 2025 average rents.",
    keywords: ["rent affordability calculator UAE", "how much rent can I afford Dubai", "Dubai rent budget calculator", "Abu Dhabi rent calculator", "UAE rent to income ratio", "Dubai upfront rental costs", "Ejari cost 2025", "security deposit Dubai", "average rent Dubai by area 2025", "rent affordability Abu Dhabi"],
...
export default function RentAffordabilityCalculatorPage() {
    ...
    return (
        <main className="container" style={{ paddingTop: "var(--s-4)" }}>
            ...
            <h1 className="t-h1" style={{ marginBottom: "var(--s-2)" }}>Rent Affordability Calculator UAE 2025 — Dubai & Abu Dhabi</h1>
            <p className="t-body text-muted" style={{ marginBottom: "var(--s-6)" }}>
                Find out exactly how much rent you can afford in the UAE. Enter your monthly salary to get your maximum affordable rent, total move-in costs (security deposit, agency fee, Ejari/Tawtheeq, DEWA/ADDC deposit), a complete monthly housing budget, and a list of Dubai and Abu Dhabi areas that fit your budget. Updated with 2025 average rental data.
            </p>
...
const CONTENT_HTML = `
    ...
    <h2 id="dubai-rents">Average Rents in Dubai by Area (2025)</h2>
    <p>Dubai rents vary enormously by area. Here are the 2025 averages for the most popular neighborhoods (monthly figures):</p>
    <table>
    ...
    <h2 id="abu-dhabi-rents">Average Rents in Abu Dhabi by Area (2025)</h2>
