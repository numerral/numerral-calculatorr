...
export default async function ChemistryCalculatorHubPage({ params }: PageProps) {
    ...
    const schemas: object[] = [
        breadcrumbSchema([{ name: "Home", url: `${SITE_URL}/` }, { name: "Chemistry Calculators", url: canonicalUrl("/chemistry-calculators") }, { name: calc.title }]), webAppSchema(calc.title, pageUrl, "USD", "EducationalApplication"),
    ];
