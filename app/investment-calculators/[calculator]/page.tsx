...
const HUB_CONTENT: Record<string, {
    ...
    "sip-calculator": {
        ...
        relatedCalculators: [{"title":"Mutual Fund Returns","slug":"mutual-fund-returns","categorySlug":"investment-calculators","description":"Calculate one-time investment returns"},{"title":"NPS Calculator","slug":"nps-calculator","categorySlug":"investment-calculators","description":"Plan your National Pension System contributions"},{"title":"CAGR Calculator","slug":"cagr-calculator","categorySlug":"investment-calculators","description":"Find the annualized growth rate"}],
    },
    "ppf-calculator": {
        ...
        relatedCalculators: [{"title":"FD Calculator","slug":"fd-calculator","categorySlug":"investment-calculators","description":"Compare with taxable FD returns"},{"title":"NPS Calculator","slug":"nps-calculator","categorySlug":"investment-calculators","description":"Another tax-saving investment option"},{"title":"Retirement Corpus","slug":"retirement-corpus-calculator","categorySlug":"investment-calculators","description":"Plan your total retirement corpus"},{"title":"Mutual Fund Returns","slug":"mutual-fund-returns","categorySlug":"investment-calculators","description":"One-time investment returns"}],
    },
    "fd-calculator": {
        ...
        relatedCalculators: [{"title":"RD Calculator","slug":"rd-calculator","categorySlug":"investment-calculators","description":"Calculate recurring deposit maturity"},{"title":"Savings Interest","slug":"savings-interest-calculator","categorySlug":"investment-calculators","description":"Calculate savings account interest"},{"title":"Deposit Maturity","slug":"deposit-maturity-calculator","categorySlug":"investment-calculators","description":"Check any deposit maturity amount"},{"title":"PPF Calculator","slug":"ppf-calculator","categorySlug":"investment-calculators","description":"Compare with tax-free PPF returns"}],
    },
    "mutual-fund-returns": {
        ...
        relatedCalculators: [{"title":"SIP Calculator","slug":"sip-calculator","categorySlug":"investment-calculators","description":"Systematic investment in mutual funds"},{"title":"CAGR Calculator","slug":"cagr-calculator","categorySlug":"investment-calculators","description":"Calculate your fund's CAGR"},{"title":"Mutual Fund Returns","slug":"mutual-fund-returns","categorySlug":"investment-calculators","description":"Generic lumpsum investment returns"},{"title":"Dividend Yield","slug":"dividend-yield-calculator","categorySlug":"investment-calculators","description":"Calculate dividend returns"}],
    },
    "savings-interest": {
    ...
    "deposit-maturity": {
        ...
        relatedCalculators: [{"title":"FD Calculator","slug":"fd-calculator","categorySlug":"investment-calculators","description":"Fixed deposit specific calculations"},{"title":"RD Calculator","slug":"rd-calculator","categorySlug":"investment-calculators","description":"Recurring deposit returns"},{"title":"Savings Interest","slug":"savings-interest-calculator","categorySlug":"investment-calculators","description":"Compare with savings account"},{"title":"PPF Calculator","slug":"ppf-calculator","categorySlug":"investment-calculators","description":"Tax-free long-term deposits"}],
    },
    "rd-calculator": {
    ...
    "nps-calculator": {
        ...
        relatedCalculators: [{"title":"PPF Calculator","slug":"ppf-calculator","categorySlug":"investment-calculators","description":"Another Section 80C tax-saving option"},{"title":"Retirement Corpus","slug":"retirement-corpus-calculator","categorySlug":"investment-calculators","description":"How much do you need to retire?"},{"title":"SIP Calculator","slug":"sip-calculator","categorySlug":"investment-calculators","description":"Compare with mutual fund SIP"},{"title":"FIRE Calculator","slug":"fire-calculator","categorySlug":"investment-calculators","description":"Calculate Financial Independence age"}],
    },
    "cagr": {
    ...
    "fire-calculator": {
        ...
        relatedCalculators: [{"title":"Retirement Corpus","slug":"retirement-corpus-calculator","categorySlug":"investment-calculators","description":"Traditional retirement planning"},{"title":"SIP Calculator","slug":"sip-calculator","categorySlug":"investment-calculators","description":"Build your FIRE corpus via SIP"},{"title":"Reverse CAGR","slug":"reverse-cagr-calculator","categorySlug":"investment-calculators","description":"Project when you'll hit your FIRE number"},{"title":"Mutual Fund Returns","slug":"mutual-fund-returns","categorySlug":"investment-calculators","description":"Lumpsum investment for FIRE"}],
    },
    "stock-return": {
        ...
        relatedCalculators: [{"title":"CAGR Calculator","slug":"cagr-calculator","categorySlug":"investment-calculators","description":"Annualized return on your stock"},{"title":"Dividend Yield","slug":"dividend-yield-calculator","categorySlug":"investment-calculators","description":"Calculate dividend income"},{"title":"Mutual Fund Returns","slug":"mutual-fund-returns","categorySlug":"investment-calculators","description":"Compare with mutual fund performance"},{"title":"Crypto Profit","slug":"crypto-profit-calculator","categorySlug":"investment-calculators","description":"Calculate crypto trading returns"}],
    },
    "dividend-yield": {
        ...
        relatedCalculators: [{"title":"Stock Return","slug":"stock-return-calculator","categorySlug":"investment-calculators","description":"Total return including capital gains"},{"title":"Mutual Fund Returns","slug":"mutual-fund-returns","categorySlug":"investment-calculators","description":"Compare with fund returns"},{"title":"FD Calculator","slug":"fd-calculator","categorySlug":"investment-calculators","description":"Compare with FD interest rate"},{"title":"CAGR Calculator","slug":"cagr-calculator","categorySlug":"investment-calculators","description":"Annualized growth rate"}],
    },
    "crypto-profit-calculator": {
        ...
        relatedCalculators: [{"title":"Stock Return","slug":"stock-return-calculator","categorySlug":"investment-calculators","description":"Compare with stock trading returns"},{"title":"CAGR Calculator","slug":"cagr-calculator","categorySlug":"investment-calculators","description":"Annualized crypto growth rate"},{"title":"IRR Calculator","slug":"irr-calculator","categorySlug":"investment-calculators","description":"True return with multiple buy/sell"},{"title":"NPV Calculator","slug":"npv-calculator","categorySlug":"investment-calculators","description":"Evaluate crypto as a cash flow investment"}],
    },
    "cagr-calculator": {
        ...
        contentHTML: `<h3>What is CAGR?</h3><p>CAGR (Compound Annual Growth Rate) is the average annual rate at which an investment grows over a specified time period, assuming profits are reinvested. Unlike simple average returns, CAGR smooths out volatility and gives you the true annualized growth rate.</p><h3>CAGR Formula</h3><p><strong>CAGR = (Ending Value / Starting Value)^(1/n) − 1</strong></p><p>Where <em>n</em> is the number of years. For example, an investment that grows from ₹1,00,000 to ₹5,00,000 in 5 years has a CAGR of (5,00,000/1,00,000)^(1/5) − 1 = <strong>37.97%</strong> per year.</p><h3>Where CAGR is Used</h3><ul><li><strong>Mutual Fund Returns:</strong> Comparing scheme performance over 3, 5, 10 years</li><li><strong>Stock Analysis:</strong> Evaluating revenue and earnings growth</li><li><strong>Portfolio Tracking:</strong> Measuring overall portfolio performance</li><li><strong>Business Valuation:</strong> Forecasting future growth based on historical data</li></ul><div class="explanation__highlight"><strong>Important:</strong> CAGR doesn't account for volatility or intermediate values. An investment that grows 100% in Year 1 and drops 50% in Year 2 ends flat — but CAGR shows 0%, hiding the wild ride.</div>`,
        faq: [
            { question: "How is CAGR different from average return?", answer: "Average return simply adds up annual returns and divides by the number of years. CAGR accounts for compounding. Example: +50% then -33% gives an average of +8.5%, but your money is actually flat (₹100 → ₹150 → ₹100). CAGR correctly shows 0%." },
            { question: "What is a good CAGR for investments?", answer: "Nifty 50 has delivered ~12-13% CAGR over 20 years. FDs give 6-7%. Top mutual funds deliver 15-18%. Real estate averages 8-10%. Any investment consistently above 15% CAGR over 10+ years is excellent." },
        ...
        relatedCalculators: [{"title":"Reverse CAGR Calculator","slug":"reverse-cagr-calculator","categorySlug":"investment-calculators","description":"Project future value from known CAGR"},{"title":"IRR Calculator","slug":"irr-calculator","categorySlug":"investment-calculators","description":"Handle multiple cash flows (more advanced)"},{"title":"SIP Calculator","slug":"sip-calculator","categorySlug":"investment-calculators","description":"Calculate SIP returns"},{"title":"Mutual Fund Returns","slug":"mutual-fund-returns","categorySlug":"investment-calculators","description":"One-time investment growth"},{"title":"NPV Calculator","slug":"npv-calculator","categorySlug":"investment-calculators","description":"Evaluate investment using discount rate"}],
    },
    "reverse-cagr-calculator": {
        ...
        contentHTML: `<h3>How Reverse CAGR Works</h3><p>The reverse CAGR calculator uses the inverse of the CAGR formula to project future values:</p><p><strong>Future Value = Initial Investment × (1 + CAGR/100)^Years</strong></p><p>This is essential for financial goal planning — if you know your expected return rate, you can project exactly how much your investment will be worth in the future.</p><h3>Use Cases</h3><ul><li><strong>Retirement Planning:</strong> "If I invest ₹10L at 12% CAGR, it becomes ₹31L in 10 years"</li><li><strong>Goal-Based Investing:</strong> "How much will my SIP corpus be worth at expected returns?"</li><li><strong>Comparing Scenarios:</strong> "₹5L at 10% vs 15% CAGR over 20 years — the gap is ₹28.6L"</li></ul>`,
        faq: [
        ...
        relatedCalculators: [{"title":"CAGR Calculator","slug":"cagr-calculator","categorySlug":"investment-calculators","description":"Calculate CAGR from known values"},{"title":"Mutual Fund Returns","slug":"mutual-fund-returns","categorySlug":"investment-calculators","description":"One-time investment returns"},{"title":"Retirement Corpus","slug":"retirement-corpus-calculator","categorySlug":"investment-calculators","description":"Plan your retirement corpus"}],
    },
    "irr-calculator": {
        ...
        contentHTML: `<h3>What is IRR?</h3><p>Internal Rate of Return (IRR) is the discount rate that makes the Net Present Value (NPV) of all cash flows equal to zero. In simple terms, it's the <strong>true annualized return</strong> of an investment when you account for the timing of each cash flow.</p><h3>IRR vs CAGR</h3><ul><li><strong>CAGR:</strong> Works with a single investment and final value — one cash inflow, one outflow</li><li><strong>IRR:</strong> Handles multiple irregular cash flows — SIPs, partial withdrawals, dividends, etc.</li></ul><p>IRR is more powerful because real-world investments rarely have just one entry and exit point.</p><h3>Decision Rule</h3><p>If IRR > your required rate of return (hurdle rate), the investment is worth pursuing. If IRR < hurdle rate, look for better alternatives.</p><div class="explanation__highlight"><strong>Example:</strong> You invest ₹1L upfront, get ₹30K/year for 4 years, and ₹45K in year 5. IRR = 18.6%. If your hurdle rate is 12%, this is a good investment.</div>`,
        faq: [
            { question: "How is IRR calculated?", answer: "IRR is found using iterative numerical methods (like binary search or Newton-Raphson). It solves: NPV = Σ [Cash Flow_t / (1+IRR)^t] = 0. There's no closed-form formula — calculators use trial-and-error to find the rate." },
    ...
    "npv-calculator": {
        ...
        contentHTML: `<h3>What is NPV?</h3><p>Net Present Value (NPV) is the difference between the present value of all future cash inflows and the initial investment cost. It answers the fundamental question: <strong>"Is this investment worth more than it costs?"</strong></p><h3>NPV Formula</h3><p><strong>NPV = Σ [Cash Flow_t / (1 + r)^t]</strong></p><p>Where <em>r</em> is the discount rate (your required return) and <em>t</em> is the time period.</p><h3>Decision Rule</h3><ul><li><strong>NPV > 0:</strong> ✅ Investment creates value — accept</li><li><strong>NPV = 0:</strong> ⚖️ Investment breaks even at your required return</li><li><strong>NPV < 0:</strong> ❌ Investment destroys value — reject</li></ul><h3>Choosing the Discount Rate</h3><p>The discount rate represents your <strong>opportunity cost</strong> — what you could earn elsewhere at similar risk. Common choices: risk-free rate (government bond yield ~7%), equity returns (12-15%), or WACC for corporate projects.</p>`,
        faq: [
            { question: "What discount rate should I use?", answer: "For personal investments, use your expected alternative return (10-12% for equity investors). For business projects, use WACC (Weighted Average Cost of Capital). For conservative analysis, use risk-free rate + risk premium (7% + 3-5%)." },
        ...
        relatedCalculators: [{"title":"IRR Calculator","slug":"irr-calculator","categorySlug":"investment-calculators","description":"Find the rate where NPV = 0"},{"title":"CAGR Calculator","slug":"cagr-calculator","categorySlug":"investment-calculators","description":"Annualized growth rate"},{"title":"Mutual Fund Returns","slug":"mutual-fund-returns","categorySlug":"investment-calculators","description":"Simple investment returns"},{"title":"Retirement Corpus","slug":"retirement-corpus-calculator","categorySlug":"investment-calculators","description":"Plan your retirement using NPV principles"}],
    },
};
