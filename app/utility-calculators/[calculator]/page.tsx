...
<li>NISM — Investor Education: Percentage-based returns</li>
        ...
        faq: [
            { question: "How do I calculate GST from a total amount?", answer: "To find GST already included in the total, use the reverse GST formula: GST Amount = Total × (Rate ÷ (100 + Rate)). For 18% GST: divide total by 1.18 to get the base price, then subtract. Example: ₹59,000 total at 18% GST → base = 59,000 ÷ 1.18 = ₹50,000, GST = ₹9,000." },
            { question: "What is percentage change and when do I use it?", answer: "Percentage change = ((New Value − Old Value) ÷ Old Value) × 100. A positive result is an increase; negative is a decrease. Use it to measure growth in sales, change in price, return on investment, or any comparison between two values over time." },
            { question: "How is percentage different from percentage points?", answer: "Percentage points measure absolute arithmetic differences. If inflation goes from 5% to 6%, that is 1 percentage point higher. But percentagewise, the inflation rate increased by (1 ÷ 5) × 100 = 20%. The distinction matters in financial, economic, and policy reporting." },
            { question: "How do I calculate a percentage of a number?", answer: "Multiply the number by the percentage divided by 100. Formula: Result = (Percentage ÷ 100) × Number. Example: 15% of ₹80,000 = (15 ÷ 100) × 80,000 = ₹12,000. Shortcut: 10% is always one decimal place shift (10% of ₹80,000 = ₹8,000); then add 5% (₹4,000) = ₹12,000 total." },
            { question: "How do I find what percentage one number is of another?", answer: "Divide the part by the whole and multiply by 100. Formula: % = (Part ÷ Whole) × 100. If you scored 72 out of 90: (72 ÷ 90) × 100 = 80%. If your salary is ₹45,000 and rent is ₹12,000: (12,000 ÷ 45,000) × 100 = 26.7% of income goes to rent." },
            { question: "How do I reverse a percentage to find the original value?", answer: "If a value has already been increased by X%, find the original: Original = Final ÷ (1 + X/100). If a salary of ₹56,000 includes a 12% hike: Original = 56,000 ÷ 1.12 = ₹50,000. For decrease: Original = Final ÷ (1 − X/100). A ₹850 item after 15% discount: Original = 850 ÷ 0.85 = ₹1,000." },
            { question: "How do I calculate a percentage increase or decrease?", answer: "Percentage increase formula: % Change = ((New − Old) ÷ Old) × 100. If stock goes from ₹150 to ₹180: (30 ÷ 150) × 100 = 20% increase. Percentage decrease: if price falls from ₹200 to ₹160: ((200−160) ÷ 200) × 100 = 20% decrease. A negative result always indicates a decrease." },
            { question: "What is the formula for a percentage of a percentage?", answer: "Compound percentages are multiplicative, not additive. 30% off + 20% off = NOT 50% off. It's: 1 − (0.7 × 0.8) = 1 − 0.56 = 44% off. On ₹1,000: after 30% off = ₹700; after 20% of ₹700 = ₹140 off → final price ₹560. The effective discount is 44%, not 50%." },
            { question: "How do you calculate percentage in Excel?", answer: "In Excel: (1) % of number: =A1*B1/100 or =A1*B1% where A1=number, B1=percentage. (2) % change: =(B1-A1)/A1 (format cell as %). (3) Increase by %: =A1*(1+B1%) (4) What % is A of B: =A1/B1 (format as %). Excel automatically handles the ×100 conversion when a cell is formatted as Percentage." },
            { question: "What is the percentage formula for tips?", answer: "Tip = Bill × Tip% ÷ 100. For a ₹2,500 restaurant bill with 18% service charge: Tip = 2,500 × 18 ÷ 100 = ₹450. Mental math shortcut: 10% of ₹2,500 = ₹250; 5% = ₹125; 3% = ₹75; Total 18% = ₹250+₹125+₹75 = ₹450. Total bill with tip = ₹2,950." },
            { question: "How do percentages apply to income tax slabs?", answer: "India's tax slabs (New Regime FY 2025-26) apply different percentage rates to income within each bracket: 0% on ₹0–₹4L; 5% on ₹4L–₹8L; 10% on ₹8L–₹12L; 15% on ₹12L–₹16L; 20% on ₹16L–₹20L; 25% on ₹20L–₹24L; 30% above ₹24L. Only the income within each bracket is taxed at that rate, not your entire income — this is the 'marginal' vs 'effective' tax rate distinction." },
            { question: "What is compound annual growth rate (CAGR) and how is it a percentage calculation?", answer: "CAGR = (End Value ÷ Start Value)^(1/Years) − 1, expressed as a percentage. Example: Investment grew from ₹1 lakh to ₹2.5 lakh in 5 years: CAGR = (2.5 ÷ 1)^(1/5) − 1 = 1.201 − 1 = 0.201 = 20.1% per year. CAGR smooths year-to-year volatility and represents the steady annual growth rate that would produce the same end result." },
            { question: "How do I calculate markup percentage vs. profit margin percentage?", answer: "Markup % = (Profit ÷ Cost) × 100. Margin % = (Profit ÷ Revenue) × 100. If you buy for ₹800 and sell for ₹1,000: Profit = ₹200. Markup = (200 ÷ 800) × 100 = 25%. Margin = (200 ÷ 1,000) × 100 = 20%. Businesses use margin to measure profitability; markup to set prices. Same profit, different perspectives — always clarify which is being used." },
        ],
    },
