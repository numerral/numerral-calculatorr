...
const faqItems = [
    { question: "What voltage do US homes use?", answer: "US residential electrical systems use a split-phase 240V service. Standard outlets provide 120V (for lights, electronics, small appliances), while dedicated circuits for large appliances (dryers, ovens, water heaters, central AC) use 240V. Commercial buildings often use 208V or 277V three-phase systems." },
