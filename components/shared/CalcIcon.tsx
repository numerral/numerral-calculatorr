...
export default function CalcIcon({ name, size = 22, className = "" }: CalcIconProps) {
  const icon = ICONS[name];
  if (!icon) return null;
  return (
    <span
      className={`calc-icon ${className}`}
